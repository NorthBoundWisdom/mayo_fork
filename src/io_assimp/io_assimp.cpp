...
{
    static const Format array[] = {Format_AMF, Format_3DS, Format_3MF,     Format_COLLADA,
                                   Format_FBX, Format_X3D, Format_Blender, Format_DirectX};
    return array;
}
...
std::string_view AssimpLib::strVersion()
{
    ...
    if (str.empty())
    {
        str += std::to_string(aiGetVersionMajor()) + "." + std::to_string(aiGetVersionMinor())
