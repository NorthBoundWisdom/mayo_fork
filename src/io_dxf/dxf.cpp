...
// details. modified 2018 wandererfan
...
template <typename T>
bool isStringToErrorValue(T value)
{
...
bool CDxfRead::ReadLine()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 230:
            // skip the next line
            break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::ReadSpline()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 210:
        case 220:
        case 230: HandleCoordCode<210, 220, 230>(n, &spline.normalVector); break;
        case 70: spline.flags = stringToUnsigned(m_str); break;
        case 71: spline.degree = stringToInt(m_str); break;
        case 72:
        ...
        case 12:
        case 22:
        case 32: HandleVectorCoordCode<12, 22, 32>(n, &spline.startTangents); break;
        case 13:
        case 23:
        case 33: HandleVectorCoordCode<13, 23, 33>(n, &spline.endTangents); break;
        case 40: spline.knots.push_back(mm(stringToDouble(m_str))); break;
        case 41: spline.weights.push_back(mm(stringToDouble(m_str))); break;
        case 10:
        case 20:
        case 30: HandleVectorCoordCode<10, 20, 30>(n, &spline.controlPoints); break;
        case 11:
        case 21:
        case 31: HandleVectorCoordCode<11, 21, 31>(n, &spline.fitPoints); break;
        case 42: spline.knotTolerance = stringToDouble(m_str); break;
        case 43: spline.controlPointTolerance = stringToDouble(m_str); break;
        case 44: spline.fitTolerance = stringToDouble(m_str); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::ReadMText()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 3:
            ...
            // Note that if breaking the text into type-3 records splits a UFT-8
            // encoding we do the decoding after splicing the lines together. I'm not
            // sure if this actually occurs, but handling the text this way will treat
...
bool CDxfRead::ReadText()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 10:
        case 20:
        case 30: HandleCoordCode(n, &text.firstAlignmentPoint); break;
        case 40: text.height = mm(stringToDouble(m_str)); break;
        case 1: text.str = this->toUtf8(m_str); break;
        case 50: text.rotationAngle = stringToDouble(m_str); break;
        case 41: text.relativeXScaleFactorWidth = stringToDouble(m_str); break;
        case 51: text.obliqueAngle = stringToDouble(m_str); break;
        case 7: text.styleName = m_str; break;
        case 72:
        {
            const int hjust = stringToInt(m_str);
            if (hjust >= 0 && hjust <= 5)
                text.horizontalJustification =
                    static_cast<Dxf_TEXT::HorizontalJustification>(hjust);
        }
        break;
        case 11:
        case 21:
        case 31: HandleCoordCode<11, 21, 31>(n, &text.secondAlignmentPoint); break;
        case 210:
        case 220:
        case 230: HandleCoordCode<210, 220, 230>(n, &text.extrusionDirection); break;
        case 73:
        {
...
bool CDxfRead::ReadVertex(Dxf_VERTEX *vertex)
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 30:
            ...
            break;
        case 40: vertex->startingWidth = stringToDouble(m_str); break;
        case 41: vertex->endingWidth = stringToDouble(m_str); break;
        case 42:
        {
        ...
        break;
        case 70: vertex->flags = stringToUnsigned(m_str); break;
        case 71: vertex->polyfaceMeshVertex1 = stringToInt(m_str); break;
        case 72: vertex->polyfaceMeshVertex2 = stringToInt(m_str); break;
        case 73: vertex->polyfaceMeshVertex3 = stringToInt(m_str); break;
        case 74: vertex->polyfaceMeshVertex4 = stringToInt(m_str); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::Read3dFace()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 10:
        case 20:
        case 30: HandleCoordCode<10, 20, 30>(n, &face.corner1); break;
        case 11:
        case 21:
        case 31: HandleCoordCode<11, 21, 31>(n, &face.corner2); break;
        case 12:
        case 22:
        case 32: HandleCoordCode<12, 22, 32>(n, &face.corner3); break;
        case 13:
        case 23:
        case 33:
            ...
            break;
        case 70: face.flags = stringToUnsigned(m_str); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::ReadSolid()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 10:
        case 20:
        case 30: HandleCoordCode<10, 20, 30>(n, &solid.corner1); break;
        case 11:
        case 21:
        case 31: HandleCoordCode<11, 21, 31>(n, &solid.corner2); break;
        case 12:
        case 22:
        case 32: HandleCoordCode<12, 22, 32>(n, &solid.corner3); break;
        case 13:
        case 23:
        case 33:
            ...
            break;
        case 39: solid.thickness = stringToDouble(m_str); break;
        case 210:
        case 220:
        case 230: HandleCoordCode<210, 220, 230>(n, &solid.extrusionDirection); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::ReadPolyLine()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        case 0:
            ...
            break;
        case 39: polyline.thickness = stringToDouble(m_str); break;
        case 70: polyline.flags = stringToUnsigned(m_str); break;
        case 40: polyline.defaultStartWidth = stringToDouble(m_str); break;
        case 41: polyline.defaultEndWidth = stringToDouble(m_str); break;
        case 71: polyline.polygonMeshMVertexCount = stringToInt(m_str); break;
        case 72: polyline.polygonMeshNVertexCount = stringToInt(m_str); break;
        case 73: polyline.smoothSurfaceMDensity = stringToDouble(m_str); break;
        case 74: polyline.smoothSurfaceNDensity = stringToDouble(m_str); break;
        case 75: polyline.type = static_cast<Dxf_POLYLINE::Type>(stringToUnsigned(m_str)); break;
        case 210:
        case 220:
        case 230: HandleCoordCode<210, 220, 230>(n, &polyline.extrusionDirection); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
void CDxfRead::OnReadArc(double start_angle, double end_angle, double radius, const DxfCoords &c,
...
void CDxfRead::OnReadCircle(const DxfCoords &c, double radius, bool hidden)
{
    ...
    const DxfCoords s = {c.x + radius * cos(start_angle * M_PI / 180),
                         c.y + radius * sin(start_angle * M_PI / 180), c.z};

    const bool dir = false; // 'false' to change direction because otherwise the
                            // arc length is zero
                             ...
                             double start_angle, double end_angle)
{
    ...
    // Since we only support 2d stuff, we can calculate the rotation from the
    // major axis x and y value only, since z is zero, major_radius is the vector
    // length
...
bool CDxfRead::ReadInsert()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        switch (n)
        {
        case 2: insert.blockName = m_str; break;
        case 10:
        case 20:
        case 30: HandleCoordCode(n, &insert.insertPoint); break;
        case 41: insert.scaleFactor.x = stringToDouble(m_str); break;
        case 42: insert.scaleFactor.y = stringToDouble(m_str); break;
        case 43: insert.scaleFactor.z = stringToDouble(m_str); break;
        case 50: insert.rotationAngle = stringToDouble(m_str); break;
        case 70: insert.columnCount = stringToInt(m_str); break;
        case 71: insert.rowCount = stringToInt(m_str); break;
        case 44: insert.columnSpacing = mm(stringToDouble(m_str)); break;
        case 45: insert.rowSpacing = mm(stringToDouble(m_str)); break;
        case 210:
        case 220:
        case 230: HandleCoordCode<210, 220, 230>(n, &insert.extrusionDirection); break;
        default: HandleCommonGroupCode(n); break;
        }
    }
...
bool CDxfRead::ReadStyle()
{
    ...
    while (!m_ifs.eof())
    {
        ...
        switch (n)
        {
        case 2: style.name = m_str; break;
        case 40: style.fixedTextHeight = mm(stringToDouble(m_str)); break;
        case 41: style.widthFactor = stringToDouble(m_str); break;
        case 50: style.obliqueAngle = stringToDouble(m_str); break;
        case 3: style.primaryFontFileName = m_str; break;
        case 4: style.bigFontFileName = m_str; break;
        default: break; // skip the next line
        }
    }
...
bool CDxfRead::ResolveEncoding()
{
    ...
    if (m_version >= R2007)
    { // Note this does not include RUnknown, but does include RLater
        return this->setSourceEncoding("UTF8");
    }
    else
    {
        std::transform(m_CodePage.cbegin(), m_CodePage.cend(), m_CodePage.begin(),
