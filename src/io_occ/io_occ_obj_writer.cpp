...
struct OccObjWriterI18N
{
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(Mayo::IO::OccObjWriterI18N)
};
...
public:
    ...
    PropertyEnum<RWMesh_CoordinateSystem> inputCoordinateSystem{
        this, OccObjWriterI18N::textId("inputCoordinateSystem")};
    PropertyEnum<RWMesh_CoordinateSystem> outputCoordinateSystem{
        this, OccObjWriterI18N::textId("outputCoordinateSystem")};
};
...
bool OccObjWriter::writeFile(const FilePath &filepath, TaskProgress *progress)
{
    ...
    try
    {
        if (m_seqRootLabel.IsEmpty())
            ...
            return writer.Perform(m_document, m_seqRootLabel, nullptr, fileInfo,
                                  occProgress->Start());
    }
