...
// Convenience class that simplifies dynamically overriding of
// QStyledItemDelegate QStyledItemDelegate protected functions cannot be
// overridden through proxy technique, this is a limitation that applies to :
