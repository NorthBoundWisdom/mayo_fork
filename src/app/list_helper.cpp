...
QVariant Model::data(const QModelIndex &index, int role) const
{
    ...
    case RoleItemPtr: return QVariant::fromValue(const_cast<ModelItem *>(item));
    case RoleItemImage:
    {
        QPixmap pixmap;
    ...
    , m_textColor(qApp->palette().color(QPalette::WindowText))
{
    ...
    QObject::connect(&m_itemAnimation, &QVariantAnimation::valueChanged, this,
                     &ItemDelegate::drawItem);
}
                         ...
                         const QModelIndex &index) const
{
    ...
    if (offset == 0)
    {
        ...
        { // Description text as fallback
            ...
            painter->drawText(rectPixmap.adjusted(6, m_itemSpacing, -6, -m_itemSpacing),
                              item->description, textOption);
        }
