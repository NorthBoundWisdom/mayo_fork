...
struct DefaultModelStorage : public ModelStorage
{
    ...
    const ItemType *at(int i) const override
    {
        return &m_items.at(i);
    }
...
public:
    ...
    QSize itemPixmapSize() const
    {
        return m_itemPixmapSize;
    }
    void setItemPixmapSize(QSize size)
    {
        m_itemPixmapSize = size;
    }
