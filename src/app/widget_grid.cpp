    ...
    , m_view(view)
{
    ...
    QObject::connect(m_ui->check_ShowGrid, &QCheckBox::clicked, this, &WidgetGrid::activateGrid);
    QObject::connect(m_ui->combo_Type, sigComboBoxActivated_int, this,
                     [=](int typeIndex)
                     {
    ...
    QObject::connect(m_ui->btn_Graphics, &QToolButton::clicked, this,
                     [=](bool on)
                     {
    ...
    QObject::connect(m_ui->btn_Color, &QToolButton::clicked, this,
                     [=] { this->chooseGridColor(GridColorType::Base); });
    QObject::connect(m_ui->btn_ColorTenth, &QToolButton::clicked, this,
                     [=] { this->chooseGridColor(GridColorType::Tenth); });
    QObject::connect(m_ui->check_ColorTenth, &QAbstractButton::toggled, this,
                     &WidgetGrid::enableGridColorTenth);
    ...
    QObject::connect(m_ui->edit_RectOriginX, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_RectOriginY, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_RectStepX, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_RectStepY, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_RectRotation, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_RectSizeX, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridGraphicsParams);
    QObject::connect(m_ui->edit_RectSizeY, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridGraphicsParams);
    QObject::connect(m_ui->edit_RectOffset, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridGraphicsParams);

    QObject::connect(m_ui->edit_CircOriginX, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_CircOriginY, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_CircRadiusStep, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_CircDivision, sigGridParamChanged_int, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_CircRotation, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridParams);
    QObject::connect(m_ui->edit_CircRadius, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridGraphicsParams);
    QObject::connect(m_ui->edit_CircOffset, sigGridParamChanged_double, this,
                     &WidgetGrid::applyGridGraphicsParams);
}
...
void WidgetGrid::applyGridParams()
{
    ...
    if (gridType == Aspect_GT_Rectangular)
    {
        viewer->SetRectangularGridValues(
            m_ui->edit_RectOriginX->value(), m_ui->edit_RectOriginY->value(),
    ...
    else if (gridType == Aspect_GT_Circular)
    {
        viewer->SetCircularGridValues(
            m_ui->edit_CircOriginX->value(), m_ui->edit_CircOriginY->value(),
...
void WidgetGrid::applyGridGraphicsParams()
{
    ...
    if (gridType == Aspect_GT_Rectangular)
    {
        viewer->SetRectangularGridGraphicValues(m_ui->edit_RectSizeX->value(),
                                                m_ui->edit_RectSizeY->value(),
                                                m_ui->edit_RectOffset->value());
    }
    else if (gridType == Aspect_GT_Circular)
    {
        viewer->SetCircularGridGraphicValues(m_ui->edit_CircRadius->value(),
                                             m_ui->edit_RectOffset->value());
    }
...
void WidgetGrid::chooseGridColor(GridColorType colorType)
{
    ...
    QObject::connect(dlg, &QDialog::rejected, this,
                     [=]
                     {
                         auto btn = colorType == GridColorType::Base ? m_ui->btn_Color :
                                                                       m_ui->btn_ColorTenth;
