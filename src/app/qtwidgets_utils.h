...
public:
    ...
    static QSize screenPixelSize(double widthRatio, double heightRatio,
                                 const QWidget *parentWidget = nullptr);

    // Add 'contentsWidget' to 'containerWidget'
    // If 'containerWidget' is empty then a QBoxLayout is created to receive
    // 'contentsWidget'
    ...
    static QMessageBox *asyncMsgBoxInfo(QWidget *parent, const QString &title, const QString &text,
                                        QMessageBox::StandardButtons buttons = QMessageBox::Ok);
    static QMessageBox *asyncMsgBoxWarning(QWidget *parent, const QString &title,
                                           const QString &text,
                                           QMessageBox::StandardButtons buttons = QMessageBox::Ok);
    static QMessageBox *asyncMsgBoxCritical(QWidget *parent, const QString &title,
                                            const QString &text,
                                            QMessageBox::StandardButtons buttons = QMessageBox::Ok);
