...
QSize QtWidgetsUtils::screenPixelSize(double widthRatio, double heightRatio,
                                      const QWidget *parentWidget)
{
    return QtGuiUtils::screenPixelSize(widthRatio, heightRatio,
                                       QtWidgetsUtils::screen(parentWidget));
}
...
QMessageBox *QtWidgetsUtils::asyncMsgBoxInfo(QWidget *parent, const QString &title,
                                             const QString &text,
...
QMessageBox *QtWidgetsUtils::asyncMsgBoxWarning(QWidget *parent, const QString &title,
                                                const QString &text,
                                                QMessageBox::StandardButtons buttons)
{
...
QMessageBox *QtWidgetsUtils::asyncMsgBoxCritical(QWidget *parent, const QString &title,
                                                 const QString &text,
                                                 QMessageBox::StandardButtons buttons)
{
