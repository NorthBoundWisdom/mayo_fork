...
void ProxyModel::setSourceModel(QAbstractItemModel *newModel)
{
    ...
    if (newModel)
    {
        ...
        QObject::connect(newModel, &QAbstractItemModel::modelAboutToBeReset, this,
                         &ProxyModel::beginResetModel);
        QObject::connect(newModel, &QAbstractItemModel::modelReset, this,
                         &ProxyModel::endResetModel);
        QObject::connect(newModel, &QAbstractItemModel::rowsAboutToBeInserted, this,
                         &ProxyModel::beginResetModel);
        QObject::connect(newModel, &QAbstractItemModel::rowsInserted, this,
                         &ProxyModel::endResetModel);
        QObject::connect(newModel, &QAbstractItemModel::rowsAboutToBeRemoved, this,
                         &ProxyModel::beginResetModel);
        QObject::connect(newModel, &QAbstractItemModel::rowsRemoved, this,
                         &ProxyModel::endResetModel);
        QObject::connect(newModel, &QAbstractItemModel::dataChanged, this,
                         &ProxyModel::onDataChanged);
    }
}
...
void ProxyModel::onDataChanged(const QModelIndex &topLeft, const QModelIndex &bottomRight,
