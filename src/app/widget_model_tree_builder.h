...
public:
    ...
    virtual bool supportsDocument(const DocumentPtr &) const
    {
        return true;
    }
    virtual bool supportsDocumentTreeNode(const DocumentTreeNode &) const
    {
        return true;
    }
    ...
    virtual WidgetModelTree_UserActions createUserActions(QObject * /*parent*/)
    {
        return {};
    }
