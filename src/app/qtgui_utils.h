...
// Returns corresponding width in pixels proportional to 'screen' width
// resolution 'screenRatio' must be within [0,1]
...
// This is a helper function to facilitates Qt5/Qt6 portability as Qt5
// QMouseEvent::globalPos() has been deprecated in Qt6
...
public:
    ...
    constexpr operator const QFont &() const
    {
        return m_font;
    }
