...
// Monitors the file system for changes to Document files owned by Application
// object When a Document is opened then DocumentFilesWatcher automatically
// monitors the corresponding file for changes. When an Document is closed then
// monitoring for that file is terminated File changes need to be acknowledged
// with DocumentFilesWatcher:acknowledgeDocumentFileChange() otherwise there
// won't be further signal notification for the changed file
