...
public:
    ...
    // Any value/enabled change will be reported to the Settings object to emit
    // signals
    ...
    PropertyEnum<ActionOnDocumentFileChange> actionOnDocumentFileChange{
        this, textId("actionOnDocumentFileChange")};
    ...
    PropertyEnumeration meshDefaultsMaterial{this, textId("material"),
                                             &OcctEnums::Graphic3d_NameOfMaterial()};
