...
static QString cssFlatComboBox(const QString &urlPixDownArrow,
    ...
    const QString css = QString(
                ...
                QComboBox::down-arrow:disabled { image: url(%4); }
                            ...
                            .arg(appPalette.color(QPalette::Window).name(),
                                 ...
                                 urlPixDownArrow, urlPixDownArrowDisabled);
    return css;
}
...
public:
    QColor color(Color role) const override
    {
        ...
        switch (role)
        {
        case Theme::Color::Palette_Base: return appPalette.color(QPalette::Base);
        case Theme::Color::Palette_Window: return appPalette.color(QPalette::Window);
        case Theme::Color::Palette_Button:
        case Theme::Color::ButtonFlat_Background: return appPalette.color(QPalette::Button);
        case Theme::Color::ButtonView3d_Background:
        {
            return appPalette.color(QPalette::Button);
        }
        case Theme::Color::ButtonFlat_Hover: return appPalette.color(QPalette::Button).darker(110);
        case Theme::Color::ButtonFlat_Checked:
            return appPalette.color(QPalette::Button).darker(125);
        case Theme::Color::ButtonView3d_Hover:
        case Theme::Color::ButtonView3d_Checked: return QColor(65, 200, 250);
        case Theme::Color::Graphic3d_AspectFillArea: return QColor(128, 200, 255);
        case Theme::Color::View3d_BackgroundGradientStart: return QColor(128, 148, 255);
        case Theme::Color::View3d_BackgroundGradientEnd: return Qt::white;
        case Theme::Color::RubberBandView3d_Line: return QColor(65, 200, 250);
        case Theme::Color::RubberBandView3d_Fill: return QColor(65, 200, 250).lighter();
        case Theme::Color::MessageIndicator_InfoBackground: return QColor(128, 200, 255);
        ...
        case Theme::Color::MessageIndicator_ErrorBackground: return QColor(225, 127, 127, 140);
        }
        return QColor();
    }
...
public:
    QColor color(Color role) const override
    {
        ...
        case Theme::Color::ButtonFlat_Background: return appPalette.color(QPalette::Button);
        case Theme::Color::ButtonFlat_Hover: return appPalette.color(QPalette::Button).darker(110);
        case Theme::Color::ButtonFlat_Checked: return appPalette.color(QPalette::Highlight);
        case Theme::Color::ButtonView3d_Background:
            return appPalette.color(QPalette::Button).lighter(125);
        case Theme::Color::ButtonView3d_Hover:
            return appPalette.color(QPalette::Button).lighter(160);
        case Theme::Color::ButtonView3d_Checked: return appPalette.color(QPalette::Highlight);
        case Theme::Color::Graphic3d_AspectFillArea: return appPalette.color(QPalette::Highlight);
        case Theme::Color::View3d_BackgroundGradientStart: return QColor(100, 100, 100);
        case Theme::Color::View3d_BackgroundGradientEnd: return QColor(200, 200, 200);
        case Theme::Color::RubberBandView3d_Line: return appPalette.color(QPalette::Highlight);
    ...
    void setup() override
    {
        ...
        for (Icon icn : MetaEnum::values<Theme::Icon>())
        {
            ...
            const QString icnBasePath =
                !fnIsNeutralIcon(icn) ? ":/images/themes/dark/" : ":/images/themes/classic/";
