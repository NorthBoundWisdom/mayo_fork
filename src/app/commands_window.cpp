...
void CommandSwitchMainWidgetMode::execute()
{
    ...
    {
    case IAppContext::Page::Home: newPage = IAppContext::Page::Documents; break;
    case IAppContext::Page::Documents: newPage = IAppContext::Page::Home; break;
    case IAppContext::Page::Unknown: break;
    }
...
void CommandSwitchMainWidgetMode::updateAction()
{
    switch (this->context()->currentPage())
    {
    case IAppContext::Page::Home: this->action()->setText(Command::tr("Go To Documents")); break;
...
bool CommandNextDocument::getEnabledStatus() const
{
    ...
    return appDocumentCount != 0 &&
           this->context()->currentPage() == IAppContext::Page::Documents &&
           currDocumentIndex >= 0 && currDocumentIndex < (appDocumentCount - 1);
}
