...
void CommandSystemInformation::execute()
{
    ...
    auto btnCopy =
        btnBox->addButton(Command::tr("Copy to Clipboard"), QDialogButtonBox::ActionRole);
...
// Helper function returning unicode representation of a QChar object in the
// form "U+NNNN"
...
// Helper function returning unicode representation of a QString object in the
// form "U+NNNNU+PPPP..."
...
QString CommandSystemInformation::data()
{
    ...
    ostr << '\n' << "Locale:\n";
    {
        ...
        ostr << indent << "std::locale:" << '\n'
             ...
             << indentx2 << "numpunct.decimal_point: " << charDecPnt << " "
             << toUnicodeHexa(charDecPnt) << '\n'
             << indentx2 << "numpunct.thousands_sep: " << char1000Sep << " "
             << toUnicodeHexa(char1000Sep) << '\n'
        ...
        ostr << indent << "QLocale:" << '\n'
             ...
             << indentx2 << "decimalPoint: " << qtLoc.decimalPoint() << " "
             << toUnicodeHexa(qtLoc.decimalPoint()) << '\n'
             << indentx2 << "groupSeparator: " << qtLoc.groupSeparator() << " "
             << toUnicodeHexa(qtLoc.groupSeparator()) << '\n';
    }
    ...
    ostr << '\n' << "C++ StdLib:\n";
    {
        ...
        ostr << indent
             ...
             << indent << "std::filepath::path::preferred_separator: " << dirSeparator << " "
             << toUnicodeHexa(dirSeparator) << '\n';
    }
    ...
    ostr << '\n' << "Screens:\n";
    {
        ...
        for (int i = 0; i < listScreen.size(); ++i)
        {
            ...
            ostr << indentx2 << "name: " << screen->name() << '\n'
                 ...
                 << indentx2 << "logicalDotsPerInch: " << screen->logicalDotsPerInch() << '\n'
                 << indentx2
                 << "primaryOrientation: " << MetaEnum::name(screen->primaryOrientation()) << '\n'
