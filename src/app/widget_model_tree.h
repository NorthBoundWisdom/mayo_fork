...
private:
    ...
    void onTreeWidgetDocumentSelectionChanged(const QItemSelection &selected,
                                              const QItemSelection &deselected);
    void onApplicationItemSelectionModelChanged(Span<const ApplicationItem> selected,
    ...
    void onNodesVisibilityChanged(const GuiDocument *guiDoc,
                                  const std::unordered_map<TreeNodeId, CheckState> &mapNodeId);
