...
void DialogTaskManager::TaskWidget::createUnboundedProgressTimer()
{
    if (!this->hasUnboundedProgressTimer())
    {
        ...
        QObject::connect(m_unboundedProgressTimer, &QTimer::timeout, this,
                         &TaskWidget::onUnboundedProgressTimeout);
...
void DialogTaskManager::onTaskStarted(TaskId taskId)
{
    ...
    QObject::connect(widget->m_interruptBtn, &QToolButton::clicked, this,
                     &DialogTaskManager::interruptTask);
