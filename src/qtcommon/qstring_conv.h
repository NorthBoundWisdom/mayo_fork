...
// const char* -> QString
template <>
struct StringConv<const char *, QString>
{
...
template <size_t N>
struct StringConv<char[N], QString>
{
...
// std::string -> QString
template <>
struct StringConv<std::string, QString>
{
...
// std::wstring -> QString
template <>
struct StringConv<std::wstring, QString>
{
    static auto to(const std::wstring &str)
    {
...
template <>
struct StringConv<std::string_view, QString>
{
...
// QByteArray -> QString
template <>
struct StringConv<QByteArray, QString>
{
    static auto to(const QByteArray &str)
    {
        return QString::fromUtf8(str);
    }
};
...
template <>
struct StringConv<TCollection_AsciiString, QString>
{
...
template <>
struct StringConv<OccHandle<TCollection_HAsciiString>, QString>
{
...
template <>
struct StringConv<TCollection_ExtendedString, QStringView>
{
...
template <>
struct StringConv<TCollection_ExtendedString, QString>
{
    static auto to(const TCollection_ExtendedString &str)
    {
...
// QString -> std::string
template <>
struct StringConv<QString, std::string>
{
...
template <>
struct StringConv<QString, std::u16string>
{
    static auto to(const QString &str)
    {
...
template <>
struct StringConv<QString, std::u16string_view>
{
    static auto to(const QString &str)
    {
...
// QString -> std::wstring
template <>
struct StringConv<QString, std::wstring>
{
    static auto to(const QString &str)
    {
...
template <>
struct StringConv<QString, TCollection_ExtendedString>
{
    static auto to(const QString &str)
    {
...
template <>
struct StringConv<QString, TCollection_AsciiString>
{
    static auto to(const QString &str)
    {
...
template <>
struct StringConv<QString, OccHandle<TCollection_HAsciiString>>
{
    static auto to(const QString &str)
    {
...
template <>
struct StringConv<TCollection_AsciiString, QByteArray>
{
    static auto to(const TCollection_AsciiString &str)
    {
...
template <>
struct StringConv<TCollection_AsciiString, QLatin1String>
{
    static auto to(const TCollection_AsciiString &str)
    {
