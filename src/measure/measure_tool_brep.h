...
public:
    ...
    MeasureDistance minDistance(const GraphicsOwnerPtr &owner1,
                                const GraphicsOwnerPtr &owner2) const override;
    MeasureDistance centerDistance(const GraphicsOwnerPtr &owner1,
                                   const GraphicsOwnerPtr &owner2) const override;
    MeasureAngle angle(const GraphicsOwnerPtr &owner1,
                       const GraphicsOwnerPtr &owner2) const override;
    ...
    static MeasureDistance brepCenterDistance(const TopoDS_Shape &shape1,
