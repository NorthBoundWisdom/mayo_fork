...
public:
    ...
    // Update the textual and graphical representations regarding some display
    // configuration
    ...
    // This function must be called before adding the graphical objects to the 3D
    // scene(Mayo::GraphicsScene or AIS_InteractiveContext)
    ...
    // This is relevant when multiple measureable 3D objects are selected. The
    // cumulative sum of each measure is computed and made available in the
    // textual and/or graphics representations
...
public:
    ...
    // Factory method to create an IMeasureDisplay object suited to input measure
    // value
    ...
    bool isSumSupported() const override
    {
        return false;
    }
...
protected:
    ...
    static void adaptScale(const OccHandle<AIS_TextLabel> &gfxText,
