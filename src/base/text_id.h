...
// QT_TRANSLATE_NOOP+=MAYO_TEXT_ID,Q_DECLARE_TR_FUNCTIONS+=MAYO_DECLARE_TEXT_ID_FUNCTIONS,tr+=textId
// file.pro
...
struct TextId
{
    ...
    // Returns the translation text of 'key' by querying registered
    // Application::Translator objects 'n' is used to support plural forms
    ...
    //     2nd arg: when != -1 used to choose an appropriate form for the
    //     translation(e.g. "%n file found" vs. "%n files found") returns:
    //     translated message
