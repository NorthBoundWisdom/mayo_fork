...
// It extends TDocStd_Document to provide an actualized model tree of its
// contents Entities are actually "root" data items
...
public:
    ...
    const Tree<TDF_Label> &modelTree() const
    {
        return m_modelTree;
    }
    ...
    // Creates entity bound to a BRep shape and registered as top-level into
    // XCAFDoc_ShapeTool
