...
void setTriangle(const OccHandle<Poly_Triangulation> &triangulation, int index,
...
// Poly_Polygon3D class interface changed from OpenCascade 7.4 to 7.5 version so
// using this class directly might cause compilation errors Prefer
// Polygon3dBuilder so application code doesn't have to care about OpenCascade
// version
class Polygon3dBuilder
{
public:
    enum class ParametersOption
    {
        None,
        With
    };
