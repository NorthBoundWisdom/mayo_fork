...
namespace
{
struct OccNameOfMaterial
{
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(OpenCascade::Graphic3d_NameOfMaterial)
};
struct OccHatchStyle
{
    MAYO_DECLARE_TEXT_ID_FUNCTIONS(OpenCascade::Aspect_HatchStyle)
};
} // namespace
