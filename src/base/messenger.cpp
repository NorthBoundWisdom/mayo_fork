...
//     : m_type(other.m_type), m_messenger(other.m_messenger),
...
MessageStream::~MessageStream()
{
    ...
    switch (m_type)
    {
    case MessageType::Trace: m_messenger.emitTrace(str); break;
    case MessageType::Info: m_messenger.emitInfo(str); break;
    case MessageType::Warning: m_messenger.emitWarning(str); break;
    case MessageType::Error: m_messenger.emitError(str); break;
    }
}
...
MessengerByCallback::MessengerByCallback(
    std::function<void(MessageType, std::string_view)> fnCallback)
