...
// Returns the value 'val' which is in range [omin..omax] to the corresponding
// value in range [nmin..nmax]
...
// Returns the min/max range of linear positions along direction 'planeNormal'
// within box 'bbc'
...
// Compares the floating point value 'f1' and 'f2' and returns true if they are
// considered equal, otherwise false. Note that comparing values where either
// 'f1' or 'f2' is 0.0 will not work, nor does comparing values where one of the
// values is NaN or infinity. If one of the values is always 0.0, use
// fuzzyIsNull() instead. If one of the values is likely to be 0.0, one solution
// is to add 1.0 to both values
