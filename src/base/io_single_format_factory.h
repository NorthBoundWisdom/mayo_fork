...
public:
    ...
    std::unique_ptr<PropertyGroup> createProperties(Format format,
...
SingleFormatFactoryReader<Fmt, FormatReader>::createProperties(Format format,
...
template <Format Fmt, typename FormatWriter>
std::unique_ptr<PropertyGroup>
SingleFormatFactoryWriter<Fmt, FormatWriter>::createProperties(Format format,
                                                               PropertyGroup *parentGroup) const
{
    if (format == Fmt)
