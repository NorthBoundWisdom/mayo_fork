...
template <>
struct StringConv<const char *, TCollection_ExtendedString>
{
...
template <size_t N>
struct StringConv<char[N], TCollection_ExtendedString>
{
...
template <>
struct StringConv<std::string_view, TCollection_AsciiString>
{
    static auto to(std::string_view str)
    {
...
template <>
struct StringConv<std::string_view, OccHandle<TCollection_HAsciiString>>
{
    static auto to(std::string_view str)
    {
...
template <>
struct StringConv<std::string_view, NCollection_Utf8String>
{
    static auto to(std::string_view str)
    {
...
template <>
struct StringConv<OccHandle<TCollection_HAsciiString>, std::string>
{
...
template <>
struct StringConv<OccHandle<TCollection_HAsciiString>, std::string_view>
{
    static auto to(const OccHandle<TCollection_HAsciiString> &str)
    {
...
template <>
struct StringConv<std::string, TCollection_AsciiString>
{
...
template <>
struct StringConv<std::string, OccHandle<TCollection_HAsciiString>>
{
    static auto to(const std::string &str)
    {
...
template <>
struct StringConv<std::string, TCollection_ExtendedString>
{
    static auto to(const std::string &str)
    {
...
template <>
struct StringConv<std::string, NCollection_Utf8String>
{
    static auto to(const std::string &str)
    {
...
template <>
struct StringConv<TCollection_AsciiString, std::string>
{
...
template <>
struct StringConv<TCollection_AsciiString, std::string_view>
{
    static auto to(const TCollection_AsciiString &str)
    {
...
template <>
struct StringConv<TCollection_ExtendedString, std::string>
{
...
template <>
struct StringConv<TCollection_ExtendedString, std::u16string>
{
    static auto to(const TCollection_ExtendedString &str)
    {
...
template <>
struct StringConv<TCollection_ExtendedString, std::u16string_view>
{
    static auto to(const TCollection_ExtendedString &str)
    {
