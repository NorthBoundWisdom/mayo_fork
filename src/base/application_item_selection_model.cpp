...
static std::vector<ApplicationItem>::iterator findApplicationItem(std::vector<ApplicationItem> &vec,
...
void ApplicationItemSelectionModel::clear()
{
    ...
    {
        // Warning: slots connected to changed() signal may indirectly access
        // m_vecSelectedItem
