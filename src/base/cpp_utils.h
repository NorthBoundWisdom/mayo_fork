...
// Type alias for the value type associated(mapped) to a key for an associative
// container(eg std::map)
...
// Returns a default empty std::string object, whose memory address can be used
// safely
...
template <typename AssociativeContainer>
MappedType<AssociativeContainer> findValue(const KeyType<AssociativeContainer> &key,
                                           const AssociativeContainer &container);

// Toggles input boolean value(eg true->false)
inline void toggle(bool &value);

// Same as std::cmp_equal() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpEqual(T t, U u) noexcept;

// Same as std::cmp_not_equal() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpNotEqual(T t, U u) noexcept;

// Same as std::cmp_less() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpLess(T t, U u) noexcept;

// Same as std::cmp_greater() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpGreater(T t, U u) noexcept;

// Same as std::cmp_less_equal() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpLessEqual(T t, U u) noexcept;

// Same as std::cmp_greater_equal() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
template <typename T, typename U>
constexpr bool cmpGreaterEqual(T t, U u) noexcept;

// Same as std::in_range() but provides an implementation if
// !__cpp_lib_integer_comparison_functions
...
// Same as static_cast<R>(t) but throws exception if 't' does not fit inside
// type 'R'
template <typename R, typename T>
constexpr R safeStaticCast(T t);
