...
{
public:
    // This constructor should be used when 'enumeration' is guaranteed to be
    // fully constructed
...
protected:
    // This constructor should be used when 'enumeration' isn't completely
    // constructed, as in PropertyEnum<> subclass. The enumeration member is set
    // with the setEnumeration() helper
...
public:
    ...
    Enumeration &mutableEnumeration()
    {
        return m_enum;
    }
